...
- **A release hands its speed to the closing morph**, so a fling keeps falling into the droplet rather than pausing at the release point. Only downward speed counts, and it can only hurry the close along, never slow it below the resting snap.
